...
const ProfileHead = () => {
  ...
  return (
    ...
    <div className="nav-item absolute right-1 top-16 bg-white border-collapse shadow-md p-8 rounded-lg w-96">
        <Link to="/student/profile"  onClick={handleClick} >
        <div>
      ...
      <div className="flex gap-5 items-center mt-6">
        <img
          ...
          src={userstudent.profile_picture}
          alt="user-profile"
        />
        <div>
          <p className="font-semibold text-xl dark:text-gray-200">{userstudent.full_name}</p>
          <p className="text-gray-500 text-sm dark:text-gray-400">Student</p>
          <p className="text-gray-500 text-sm font-semibold dark:text-gray-400"> #{userstudent.student_id} </p>
        </div>
      </div>
      </div>
      </Link>
